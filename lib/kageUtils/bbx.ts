// https://raw.githubusercontent.com/kurgm/kage-editor/master/src/kageUtils/bbx.ts
// author: kurgm
...
export const getGlyphLinesBBX = memoizeOne(
  (glyphLines: GlyphLine[]): BBX => {
